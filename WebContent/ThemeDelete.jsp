...
<title>Delete a Loan Theme</title>
</head>
<body>
...
<nav class="navbar navbar-expand-sm navbar-dark bg-primary" style="margin-bottom: 40px">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
	...
	<form action="themeDelete" method="post">
		<h4 style="margin-bottom: 15px">Delete a loan theme</h4>
		<p>
			<div>
				<label for="loanThemeId">Loan Theme ID</label>
				<input id="loanThemeId" type="text" name="loanThemeId" placeholder="Enter a Loan Theme ID" value="${fn:escapeXml(param.loanThemeId)}">
