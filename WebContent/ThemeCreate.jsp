...
<title>Create a Loan Theme</title>
</head>
<body>
...
<nav class="navbar navbar-expand-sm navbar-dark bg-primary" style="margin-bottom: 40px">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
	...
	<form action="themeCreate" method="post">
		<h4 style="margin-bottom: 15px">Create a loan theme</h4>
		<p>
			<label for="loanThemeId">Loan Theme ID</label>
			<input id="loanThemeId" type="text" name="loanThemeId" placeholder="Enter a Loan Theme ID" value="">
		</p>
		<p>
			<label for="loanThemeDesp">Loan Theme Description</label>
			<input id="loanThemeDesp" name="loanThemeDesp" placeholder="Enter Loan Theme Description" value="">
		</p>
		<p>
