...
<!--           <div class="dropdown-divider"></div>
	...
	<form action="partnerdelete" method="post">
		<h4 style="margin-bottom: 15px">Delete a partner</h4>
		<p>
			<div>
		...
		<p>
			<a href="findpartners"><button type="button" class="btn btn-outline-primary btn-sm">Back to Partners</button></a>
		</p>
	</form>
	<br/><br/>
	<p>
